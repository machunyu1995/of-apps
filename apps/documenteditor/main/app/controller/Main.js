...
//                this.getMainMenu().closeFullScaleMenu();
            ...
            onLongActionBegin: function(type, id) {
                ...
                if(id == Asc.c_oAscAsyncAction['ForceSaveButton']){
                    Common.Gateway.onSaveStart();
                }
            },

            onSaveRefused: function() {
                 Common.Gateway.onSaveComplete();
            },
...
//                        this.onEditComplete(this.loadMask); //если делать фокус, то при принятии чужих изменений, заканчивается свой композитный ввод
            ...
            onDocumentContentReady: function() {
                ...
                me.api.asc_registerCallback('asc_onSaveRefused',              _.bind(me.onSaveRefused, me));
