...
if (window.Common === undefined) {
    ...
    Common.Gateway = new(function() {
        ...
        return {
            ...
            onSaveStart: function (data) {
                _postMessage({ event: 'onSaveStart', data: data });
            },

            onSaveComplete: function (data) {
                _postMessage({ event: 'onSaveComplete', data: data });
            },

            onSaveRefused: function (data) {
                _postMessage({ event: 'onSaveRefused', data: data });
            }
        }
